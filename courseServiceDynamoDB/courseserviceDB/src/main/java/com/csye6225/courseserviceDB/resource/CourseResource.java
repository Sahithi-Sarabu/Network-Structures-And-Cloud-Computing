...
import com.csye6225.courseserviceDB.service.Course;
import com.csye6225.courseserviceDB.service.CourseService;
...
public class CourseResource {
	...
	CourseService courseServ = ServiceFactory.getServiceFactory().getCourseService();
	...
	@Path("course/{courseId}/professor/{profId}")
	@GET
	...
	@Path("course/{courseId}/TA/{studentId}")
	@GET
