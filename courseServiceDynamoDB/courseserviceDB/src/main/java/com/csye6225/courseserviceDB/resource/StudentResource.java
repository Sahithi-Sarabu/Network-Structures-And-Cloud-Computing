...
import com.csye6225.courseserviceDB.service.Student;
import com.csye6225.courseserviceDB.service.StudentService;

@Path("students")
public class StudentResource {
	
	StudentService studentService = ServiceFactory.getServiceFactory().getStudentService();
