...
import com.csye6225.courseserviceDB.service.Professor;
import com.csye6225.courseserviceDB.service.ProfessorService;
...
public class ProfessorResource {
	...
	ProfessorService profService = ServiceFactory.getServiceFactory().getProfessorService();
	@GET
	...
	public Professor getProfessorById(@PathParam("id") String id) {
		return profService.getProfessorById(id);
	}
