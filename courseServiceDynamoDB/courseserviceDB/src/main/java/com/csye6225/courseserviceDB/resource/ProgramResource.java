...
import com.csye6225.courseserviceDB.service.Program;
import com.csye6225.courseserviceDB.service.ProgramService;
import com.csye6225.courseserviceDB.service.ServiceFactory;

@Path("programs")
public class ProgramResource {
	
	ProgramService progserv = ServiceFactory.getServiceFactory().getProgramService();;
	...
	public Program getProgramById(@PathParam("id") String id) {
		return progserv.getProgramById(id);
	}
	...
	@Path("program/{programId}/course/{courseName}")
	@GET
